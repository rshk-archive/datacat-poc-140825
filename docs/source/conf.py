...
project = u'Datacat'
copyright = u'2014, Samuele Santi - TrentoRISE'
...
latex_documents = [
    ('index', 'Datacat.tex', u'Datacat Documentation',
...
man_pages = [
    ('index', 'datacat', u'Datacat Documentation',
     [u'Samuele Santi'], 1)
]
...
texinfo_documents = [
    ('index', 'Datacat', u'Datacat Documentation',
     u'Samuele Santi', 'Datacat', 'One line description of project.',
     'Miscellaneous'),
]
